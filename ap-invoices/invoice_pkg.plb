create or replace package body invoice_pkg as
  ...
  begin
    ...
    l_q := 'InvoiceDate >= "' || to_char(p_start_date, 'YYYY-MM-DD') || '"'
        || ';InvoiceDate <= "' || to_char(p_end_date,   'YYYY-MM-DD') || '"';
    ...
    apex_collection.create_or_truncate_collection('FUSION_INVOICE_ROWS');
    ...
    loop
      apex_collection.add_member(
        p_collection_name => 'FUSION_INVOICE_ROWS',
